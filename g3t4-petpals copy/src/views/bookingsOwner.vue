...
<script>
    ...
    export default {
        data() {
            return {
                count: 0,
                type: 'Pet Service Provider', // other users type
                pendings: [],
                reqs: [],
                bookings: [],
                haveReq: false,
        ...
        mounted(){
            ...
            // :name = 'item.other' :desc = 'item.desc' :rates = 'item.rates' 
            // :location = 'item.address' :yrsOfExp = 'item.yrsOfExp' 
            // :otherid = 'item.otherid' :img = 'item.img' 
            // :ratings = 'item.ratings' :services = 'item.services'
