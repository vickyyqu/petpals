...
declare interface AutoLink extends Leaf {
    type: "autolink";
    url: string;
}
...
declare interface CodeBlock extends Leaf {
    type: "codeblock";
    language: string | null;
}

declare interface CodeSpan extends Leaf {
    type: "codespan";
}
...
declare interface Emoji extends Leaf {
    type: "emoji";
    kind: "emoticon" | "name" | "unicode";
}

declare type Entity = Suppressed | Emoji | Markup | Blockquote | CodeSpan | CodeBlock | Link | Mention | AutoLink;

/**
 * A multi-root tree, which describes a bunch of formatting and logical entities within a message.
 */
declare type EntityTree = EntityTreeNode[];

declare type EntityTreeNode = string | Entity;
...
declare interface Link extends Clickable {
    type: "link";
    url: string;
}
...
declare interface Mention extends Leaf {
    type: "mention";
 ...
 * custom action defined in the dashboard.
 */
...
export declare class Session {
     ...
     *
     * @remarks
     * The Inbox is TalkJS's most versatile component. It combines a {@link Chatbox} with a panel
     * showing a a list of conversations where the user is a participant. After creating an Inbox,
     * you need to {@link Inbox.mount} it to make it visible in your app.
     *
    ...
    /**
     * @public
     * @deprecated Use `createChatbox({ selected: myConversation })` instead
     * @hidden
     */
    createChatbox(conversation: Conversation | ConversationBuilder | null | undefined, options?: ChatboxOptions): Chatbox;
    /**
     * @public
     * @deprecated Use `createPopup({ selected: myConversation })` instead
     * @hidden
     */
...
declare interface Suppressed extends Leaf {
    type: "suppressed";
}
