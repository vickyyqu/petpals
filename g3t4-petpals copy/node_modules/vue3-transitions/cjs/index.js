'use strict';Object.defineProperty(exports,'__esModule',{value:true});var vue=require('vue');var commonjsGlobal = typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};
...
var sharedStore = store$1;var functionToString = Function.toString;
...
var props = {
  ...
  setup: function setup(props, _a) {
    ...
    var baseProps = vue.computed(function () {
    ...
    var defaultDuration = vue.ref(500);
    var durationObj = vue.computed(function () {
      var _a, _b;
...
var es_function_name = {
  ...
  return _ctx.group ? (vue.openBlock(), vue.createBlock(vue.TransitionGroup, vue.mergeProps({
    key: 0
  }, _ctx.baseProps, {
    ...
    _: 3
  }, 16, ["name"])) : (vue.openBlock(), vue.createBlock(vue.Transition, vue.mergeProps({
    key: 1
  }, _ctx.baseProps, {
  ...
  setup: function setup(props) {
    var transitionType = vue.ref('fio'); // FadeInOut
  ...
  var _component_BaseTransitionComponent = vue.resolveComponent("BaseTransitionComponent");

  return vue.openBlock(), vue.createBlock(_component_BaseTransitionComponent, vue.mergeProps(_ctx.props, {
...
styleInject(css_248z$1);script$1.render = render$1;var script = vue.defineComponent({
  ...
  setup: function setup(props) {
    var transitionType = vue.ref('sio'); // SlideInOut
...
styleInject(css_248z);script.render = render;var components=/*#__PURE__*/Object.freeze({__proto__:null,FadeInOut: script$1,SlideInOut: script});var install = function install(app) {
  Object.entries(components).forEach(function (_a) {
    var componentName = _a[0],
        component = _a[1];
    app.component(componentName, component);
  });
};exports.FadeInOut=script$1;exports.SlideInOut=script;exports.default=install;