  ...
  <div class="container-fluid profile-page">
    ...
    <div class="profile-container">
      ...
      <div class="profile-info">
        <div class="container">
          <button @click="toggleModal" class="btn btn-go">
      ...
      <div class="profile-about">
        <img src="../img/animallogo/doglogo2.png" />&nbsp;<img
          src="../img/animallogo/catlogo2.png"
        />&nbsp;<img src="../img/animallogo/rabbitlogo2.png" />&nbsp;<img
          src="../img/animallogo/guineapiglogo2.png"
        />&nbsp;<img src="../img/animallogo/birdlogo2.png" />
      ...
      <div class="form-group">
        ...
        <label class="" for="petserviceprovider">
          <input
            type="checkbox"
            name="checkboxes"
            id="petserviceprovider"
            value="Pet Service Provider"
          />
