            ...
            <div class="col-md-4 order-md-2 content-login">
                <div class="box">
                    <div v-if="forgot" class="login mt-5" style="padding-bottom:304px;">
                        ...
                        <div class="my-3">
                            ...
                            <div class="form w-100 mt-4">
                                <input autocomplete="off" v-model='email' id="email" class="form-control px-0"
                                    style="color:#4b3830" required />
                            ...
                            <div v-if="emailError" class="text-center mt-1">
                    ...
                    <div v-else class="login">
                        ...
                        <div class="form w-100 mt-4">
                            <input type="password" v-model='pwd' v-on:keyup.enter='userLogin()'
                                class="form-control px-0" id="pwd" autocomplete="off" required />
                        ...
                        <button class="btn p-0"
                            style="background-color:transparent; border-color:transparent; font-size:12px; color:#F8AA9D"
                            @click="forgot = true">Forgot password?</button>
                        ...
                        <div class="text-center">
                            ...
                            <div class="dropdown mt-3">
                                ...
                                <div class="dropdown-content">
                                    <router-link to="/registerowner" style="font-size:16px;text-decoration:none"
                                        class="text-center pt-2 ">I am a pet owner.</router-link>
                                    <router-link to="/registerprovider" style="font-size:16px;text-decoration:none;"
                                        class="text-center pt-2 ">I am a pet service provider.</router-link>
                                </div>
                            </div>
                        </div>
                ...
                <svg class="curveDownColor" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100"
                    style="fill:white;stroke:white;z-index:-1;" viewBox="0 0 100 100" preserveAspectRatio="none">
        ...
        <div class="m-sm-5 pt-5" id="gallery">
            ...
            <div class="row m-5">
                <div class="col-sm-4 mb-4 mb-lg-0 ">
                    <img src="@/img/gallery/img1.jpeg" class="w-100 shadow-1-strong rounded mb-4" />

                    <img src="@/img/gallery/img4.jpeg" class="w-100 shadow-1-strong rounded mb-4" />
                </div>

                <div class="col-sm-4 mb-4 mb-lg-0">
                    <img src="@/img/gallery/img3.jpeg" class="w-100 shadow-1-strong rounded mb-4" />

                    <img src="@/img/gallery/img2.jpeg" class="w-100 shadow-1-strong rounded mb-4" />
                </div>

                <div class="col-sm-4 mb-4 mb-lg-0">
                    <img src="@/img/gallery/img6.jpeg" class="w-100 shadow-1-strong rounded mb-4" />

                    <img src="@/img/gallery/img5.webp" class="w-100 shadow-1-strong rounded mb-4" />
                </div>
            </div>
        </div>
        ...
        resetPassword() {
            ...
            if (this.email != ""){
                ...
                .catch((error) => {
                    ...
                    this.errorMsg = 'No registered account found under email.'
                });
